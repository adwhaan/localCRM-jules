...
namespace LocalCRM.WebApi.Controllers
{
    ...
    public class TagsController : ControllerBase
    {
        ...
        [HttpPost] public async Task<ActionResult<TagDto>> Create(TagDto dto) => Ok(await _tagService.CreateAsync(dto));
        [HttpDelete("{id}")] public async Task<IActionResult> Delete(int id) => await _tagService.DeleteAsync(id) ? NoContent() : NotFound();
    }
    ...
    public class SettingsController : ControllerBase
    {
        ...
        [HttpGet] public async Task<ActionResult<IEnumerable<SettingDto>>> GetAll() => Ok(await _settingService.GetAllAsync());
        ...
        [HttpPut("{key}")] public async Task<IActionResult> Update(string key, [FromBody] string value) => await _settingService.UpdateAsync(key, value) ? NoContent() : NotFound();
    }
